...
using CarController = Assets.RTS.Scripts.Navigation.GamePlusJam.VehicleController;

namespace UnityStandardAssets.Vehicles
{
	...
	public class CarAIControl : MonoBehaviour
	{
		...
		private void FixedUpdate()
		{
			...
			{
				SetTarget(pathfinder.target.transform);
			}
